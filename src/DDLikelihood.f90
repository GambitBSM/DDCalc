PROGRAM DDLikelihood
  ...
  REAL*8 :: BGlogL,mDM,sigmaSI,mDMmin,mDMmax,sigmaSImin,sigmaSImax,fp,fn,lnp,Gp
...
!      fn = SigmanSItoFn(mDM,sigmaSI)
      Gp = SigmapSDtoAp(mDM,sigmaSI)
!      CALL DDCalc_SetWIMP(WIMP,m=mDM,DMtype='SIonly',params=[fp,fn])
      CALL DDCalc_SetWIMP(WIMP,m=mDM,DMtype='SDonly',params=[Gp,0d0])
      CALL DDCalc_CalcRates(Detector, WIMP, Halo)
